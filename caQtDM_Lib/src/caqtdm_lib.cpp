...
*/
    ...
    //==================================================================================================================
        ...
        QHBoxLayout *boxLayout = Q_NULLPTR;//includeWidget->getIncludeboxLayout();//new QHBoxLayout;
        if (boxLayout) boxLayout->setMargin(0);
...
#if QT_VERSION < QT_VERSION_CHECK(5, 0, 0)
                  if(gridLayout) gridLayout->setMargin(includeWidget->getFrameLineWidth());
#endif
                  break;
