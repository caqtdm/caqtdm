...
signtool sign /fd SHA256 /n %CAQTDM_SIGNER% /t %TIMESTAPER% caQtDM.exe caQtDM_Lib.dll qtcontrols.dll adl2ui.exe .\controlsystems\demo_plugin.dll .\controlsystems\epics3_plugin.dll .\controlsystems\bsread_plugin.dll .\controlsystems\archiveSF_plugin.dll .\designer\qtcontrols_controllers_plugin.dll .\designer\qtcontrols_graphics_plugin.dll .\designer\qtcontrols_monitors_plugin.dll .\designer\qtcontrols_utilities_plugin.dll
GOTO FINISHED
