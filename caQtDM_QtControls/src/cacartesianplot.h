...
public:
    ...
    void setPV1List(QStringList list) {thisPV[0] = list;}
    ...
    void setPV2List(QStringList list) {thisPV[1] = list;}
    ...
    void setPV3List(QStringList list) {thisPV[2] = list;}
    ...
    void setPV4List(QStringList list) {thisPV[3] = list;}
    ...
    void setPV5List(QStringList list) {thisPV[4] = list;}
    ...
    void setPV6List(QStringList list) {thisPV[5] = list;}
