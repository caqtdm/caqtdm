...
#include "caPropHandle.h"
    ...
    void setLabelsList(QStringList list) {labels = list; updatePropertyEditorItem(this, "labelsList");}

    QString getFiles() const {return files.join(";");}
    void setFiles(QString const &newL);
    QStringList getFilesList() const {return files;}
    void setFilesList(QStringList list) {files = list; updatePropertyEditorItem(this, "filesList");}

    QString getArgs() const {return args.join(";");}
    void setArgs(QString const &newL) ;
    QStringList getArgsList() const {return args;}
    void setArgsList(QStringList list) {args = list; updatePropertyEditorItem(this, "argsList");}
