...
# define CHANNELMASK    "channelMask: Name of pv used in order to mask the items in the puldownmenu,\n16 bits can be used where a bit not set hides the item and set shows it"
